      ...
      if (!slider.animating) {
        ...
        if (slider.vars.animation.toLowerCase() == "slide") {
          if (slider.currentSlide == 0 && target == slider.count - 1) {
            slider.container.animate({"marginLeft": "0px"}, slider.vars.animationDuration, 'swing', function(){
            ...
            slider.container.animate({"marginLeft": (-1 * (slider.count + 1)) * slider.slides.filter(':first').width() + "px"}, slider.vars.animationDuration, 'swing', function(){
